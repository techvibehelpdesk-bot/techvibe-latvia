...
export default function AutoPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 py-20 px-6 lg:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-28">
          <div className="inline-flex items-center gap-6 bg-white/80 backdrop-blur-xl px-16 py-8 rounded-[3rem] shadow-2xl border border-white/50 mb-12">
            ...
            <div>
              <h1 className="text-6xl lg:text-7xl font-black bg-gradient-to-r from-slate-900 to-indigo-900 bg-clip-text text-transparent mb-4">
                Auto sludinājumi
              </h1>
          ...
          <Link href="/ievietot" className="group inline-flex items-center gap-4 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-black text-xl py-6 px-12 rounded-[2.5rem] shadow-2xl hover:shadow-3xl hover:scale-[1.02] transition-all duration-300 border border-emerald-300/50">
            <span className="text-3xl group-hover:rotate-12 transition-transform">➕</span>
            Pievienot auto
          </Link>
        </div>

        {/* KARTĪTES GRID - PRECĪZI KĀ SCREENSHOT */}
          ...
          {sludinajumi.map((item) => {
            ...
            return (
              <Link 
                ...
                className="group bg-white rounded-[2.5rem] p-10 shadow-2xl hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] border border-slate-100 hover:border-indigo-200 hover:-translate-y-4 transition-all duration-500 overflow-hidden hover:bg-slate-50"
              >
                {/* Image container kā screenshot */}
                <div className="w-full h-72 rounded-2xl overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 mb-10 shadow-xl group-hover:shadow-2xl transition-all duration-700">
                  <img 
                    src={firstImage}
                    alt={item.title}
                ...
                {/* Title */}
                <h3 className="font-bold text-2xl lg:text-3xl mb-6 line-clamp-2 text-slate-900 group-hover:text-indigo-900 transition-colors leading-tight">
                  {item.title}
                </h3>

                {/* PRICE - LIELS KĀ SCREENSHOT */}
        ...
        {sludinajumi.length === 0 && !error && (
          <div className="text-center py-48">
            <div className="w-48 h-48 mx-auto mb-16 p-16 bg-gradient-to-br from-yellow-100 to-orange-100 rounded-[3rem] shadow-2xl flex items-center justify-center">
            ...
            <Link href="/ievietot" className="inline-flex items-center gap-4 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-black text-2xl py-8 px-20 rounded-[3rem] shadow-3xl hover:shadow-4xl hover:scale-105 transition-all duration-500">
