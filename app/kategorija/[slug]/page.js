...
export default function KategorijaPage() {
  ...
  const kategorija = params?.slug || 'telefoni'
  ...
  const kategorijaData = kategorijuDati[kategorija] || kategorijuDati.telefoni
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <input type="number" className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" placeholder="Min" />
                  <input type="number" className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" placeholder="Max" />
                </div>
              </div>
                ...
                <Link href={`/sludinajums/${slud.id}`} key={slud.id} className="group">
                  <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-2xl hover:border-purple-400 transition-all overflow-hidden h-full">
                    <div className="w-full h-48 bg-gradient-to-br from-purple-100 to-blue-100 rounded-lg flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                      <span className="text-5xl">🚗</span> {/* Mainīt ikonas per kategoriju */}
                    </div>
