...
export default function DatoriPage() {
  ...
  async function fetchData() {
    try {
      ...
      let filtered = data.filter(
        (s) =>
          s.category?.toLowerCase().includes('datori') &&
          s.status === 'published'
      )
      ...
      console.error('Datori Error:', err)
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 mb-12 flex flex-wrap items-center gap-4 shadow-sm">
          <input
            placeholder="Meklēt datorus, klaviatūras, monitorus..."
            value={search}
          ...
          <Link
            href="/ievietot?kategorija=datori"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">
          {sludinajumi.map((item) => {
            const firstImage =
              ...
              'https://via.placeholder.com/300x200/f8f9fa/6c757d?text=💻+Dators'
        ...
        {sludinajumi.length === 0 && (
          <div className="text-center py-24">
            ...
            <h2 className="text-3xl font-bold mb-4">Vēl nav datoru sludinājumu</h2>
            <Link
              href="/ievietot?kategorija=datori"
        ...
        <div className="text-center p-12 bg-gray-50 rounded-2xl border border-gray-200">
          <h2 className="text-3xl font-bold mb-6">
            Pārdod vai pērc datorus un tehniku!
          </h2>
          <Link
            href="/ievietot?kategorija=datori"
