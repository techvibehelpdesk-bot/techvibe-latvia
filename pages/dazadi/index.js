...
export default function DazadiPage() {
  ...
  async function fetchData() {
    try {
      ...
      let filtered = data.filter(
        (s) =>
          s.category?.toLowerCase().includes('dazadi') &&
          s.status === 'published'
      )
      ...
      console.error('Dazadi Error:', err)
    } finally {
      setLoading(false)
    }
  }
      ...
      <nav className="bg-white border-b border-gray-200 px-6 py-6 shadow-sm">
        <div className="max-w-7xl mx-auto flex justify-center">
          <div className="flex items-center gap-2 px-8 py-3 bg-gray-50 border border-gray-200 rounded-2xl shadow-md">
            ...
            <span className="text-2xl font-bold text-blue-600">🔄 Dažādi</span>
            <div className="w-px h-6 bg-gray-300 mx-4" />
            <Link
              href="/test-auto"
              className="text-lg font-semibold text-gray-700 hover:text-gray-900"
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex justify-between items-center mb-12">
          ...
          <p className="text-2xl text-gray-600">
            {sludinajumi.length} sludinājumi
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 mb-12 flex flex-wrap items-center gap-4 shadow-sm">
          <input
            placeholder="Meklēt jebko – pakalpojumus, mantas, piedāvājumus..."
            value={search}
          ...
          <Link
            href="/ievietot?kategorija=dazadi"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">
          {sludinajumi.map((item) => {
            const firstImage =
              ...
              'https://via.placeholder.com/300x200/f8f9fa/6c757d?text=🔄+Dažādi'
              ...
              >
                <div className="p-6">
                  ...
                  <h3 className="font-bold text-lg mb-2 line-clamp-2">
                    {item.title || 'Dažāds piedāvājums'}
                  </h3>
                  <p className="text-gray-600 text-sm mb-6 line-clamp-2">
                    {item.description?.slice(0, 100) ||
                      `${item.location || 'Rīga'} • Dažādi`}
                  </p>
        ...
        {sludinajumi.length === 0 && (
          <div className="text-center py-24">
            ...
            <h2 className="text-3xl font-bold mb-4">Vēl nav dažādu sludinājumu</h2>
            <Link
              href="/ievietot?kategorija=dazadi"
        ...
        <div className="text-center p-12 bg-gray-50 rounded-2xl border border-gray-200">
          <h2 className="text-3xl font-bold mb-6">
            Publicē visu ko vēlies – pakalpojumus, mantas, piedāvājumus!
          </h2>
          <Link
            href="/ievietot?kategorija=dazadi"
