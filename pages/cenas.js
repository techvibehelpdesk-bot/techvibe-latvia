    ...
    <div className="min-h-screen bg-gray-50">
      <section className="pt-24 pb-20 px-4 bg-gradient-to-r from-blue-600 to-indigo-700 text-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-12 opacity-90">Ss.lv analogas funkcijas par zemākām cenām</p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-20">Mūsu plāni vs Ss.lv</h2>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
                  ...
                  <th className="p-6 text-center text-xl font-bold">Ss.lv</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                <tr>
                  ...
                  <td className="p-6 text-center font-bold text-green-600">Neierobežots</td>
                  <td className="p-6 text-center text-red-500">€2.25+ katrs</td>
                </tr>
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="p-6 text-center text-red-500">€5.32+</td>
                </tr>
                <tr>
      ...
      <section className="py-20 px-4 text-center bg-white">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Sāc pelnīt!</h2>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/ievietot" className="bg-blue-600 text-white px-12 py-5 text-2xl font-bold rounded-2xl hover:shadow-2xl transition-all inline-block">
